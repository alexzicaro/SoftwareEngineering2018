...
public class MapBuilder {
	...
	private void buildRoads(){
		...
		roads.put("EastWest",new Road(new Point(415,400),new Point (785,400),Direction.EAST,true,true));	
	}
	...
	private void assignGatesToRoads(){
		roads.get("Eastern Highway").assignGate(gates.get("Gate1"), gates.get("Gate2"));
		roads.get("Western Highway").assignGate(gates.get("Gate2"), gates.get("Gate1"));
	}
